...
After install, open MSYS2 UCRT64 from Start Menu (the orange icon)
Run these commands inside the MSYS2 terminal:
pacman -Syu
...
Type a title (e.g., Operating Systems Notes)
...
License
MIT — Made by Rohit Dubey (Free To Use)
